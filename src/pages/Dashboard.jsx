...
// Candidate Image with skeleton + fade-in
function CandidateImage({ src, alt }) {
  ...
  return (
    <div className="w-24 h-24 mx-auto relative">
      ...
      <img
        src={src}
        alt={alt}
        className={`w-24 h-24 rounded-full object-cover border-2 border-gray-100 transition-opacity duration-500 ${
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="space-y-10 animate-pulse">
            {[1, 2].map((section) => (
              <section key={section} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[1, 2, 3].map((card) => (
                    <div key={card} className="bg-white border border-gray-200 rounded-xl p-6 space-y-3">
                      ...
                      <div className="h-8 bg-gray-200 rounded w-full mx-auto mt-2"></div>
                    </div>
                  ))}
                </div>
              </section>
                      ...
                      <div key={position.id}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                          {position.candidates.map((candidate) => (
                            ...
                            >
                              <CandidateImage src={candidate.image_url} alt={candidate.name} />

                              <h4 className="font-semibold text-gray-900 mt-4">{candidate.name}</h4>
        ...
        >
          ...
          >
            ...
            <div className="text-center">
              <CandidateImage src={selectedCandidate.image_url} alt={selectedCandidate.name} />
